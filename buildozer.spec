...
# containing the necessary HTML, JS, and WASM files.
...
# The XCode project folder.
ios.project_dir = ArtifyStudio-iOS

# The app ID.
ios.app_id = com.roshan.artifystudio

# The app name.
ios.app_name = ArtifyStudio
...
# The following steps are for configuration only. The final compilation
